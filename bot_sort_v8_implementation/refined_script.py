...
def main():
    ...
    # Note: Make sure 'weights.pt' is in the exact same folder as this script, OR provide the absolute path.
    ...
    while cap.isOpened():
        ...
        results = model.track(frame, persist=True, tracker=r"c:\Users\MVMaas\.antigravity\pbl_ai\tester.yaml", conf=0.15,verbose=False)
